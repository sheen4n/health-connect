...
import { SupportPage, SignupPage, AccountPage, LoginPage, TabsPage, MapPage, InboxPage, UserPage, AllFacilitiesPage, FacilityDetailPage, ChatPage, FavoritesPage } from './pages';
...
export class MyApp {
  ...
  appPages: PageInterface[] = [
    ...
    { title: 'Favorites', name: 'TabsPage', component: TabsPage, tabComponent: FavoritesPage, index: 1, icon: 'star' },
  ...
  loggedInPages: PageInterface[] = [
    ...
    { title: 'Contact Providers', name: 'UserPage', component: UserPage, icon: 'people' },
